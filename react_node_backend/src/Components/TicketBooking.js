...
class TicketBooking extends Component {
  ...
  constructor(props) {
    ...
    this.state = {a_tickets: 0, s_tickets: 0, sc_tickets: 0, c_tickets: 0, adult_total_amount: "$0.00", student_total_amount: "$0.00",
    child_total_amount: "$0.00", sc_total_amount: "$0.00"};
  }
              ...
              <div id="siteContainer">
                <div id="headerContainer" class="purchase detail on-order" name="HeaderContainer">
                    <div class="commonContainer">
                      <div id="memberGreeting">hi, Murtaza</div>
                    </div>
                                      ...
                                      <table class="section quantityTable">
                                        <tbody class="ticketTypeTable" ID="0000000001">
                                            <tr>
                                              ...
                                              <td class="pricePerTicket">$10.00</td>
                                              <td class="equals">=</td>
                                            ...
                                            <tr>
                                              ...
                                              <td class="timesX">x</td>
                                              <td class="pricePerTicket">$5.00</td>
                                              <td class="equals">=</td>
                          ...
                          <div class="module-standard">
                            <div id="movieTicketSummary">
                                ...
                                <div class="moviePoster">
                                  <img id="moviePosterImage" alt="" src="https://images.fandango.com/r1.0.589/redesign/static/img/default_poster_128x190.png" />
                                </div>
                                <div class="movieInfo">
                                  <ul class="movie-specs">
                                      <li class="title">
                                        <h3 id="movieTitle">Swathandrayam Ardarathriyil</h3>
                                      </li>
                                      <li class="info"><span id="ratingInfo" class="emptyCheck"></span><span id="ratingSeparator" class="separator emptyCheck"> </span><span class="emptyCheck" id="runtimeInfo">2 hr 17 min</span></li>
                                  </ul>
                                  <ul class="movie-other-specs">
                                      <li>
                                        <h2 id="movieDate">Thursday, Apr 19 </h2>
                                      </li>
                                      <li>
